...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; text-decoration: none; border: none !important; outline: none; }
        ...
        .img-box img { width: 90%; max-width: 500px; border-radius: 2px; cursor: zoom-in; transition: 0.4s; }
        ...
        h4 { font-family: 'Playfair Display', serif; font-size: 1.4rem; color: var(--color); margin: 15px 0 10px; }
        ...
        .specs-list li { margin-bottom: 8px; font-size: 0.85rem; color: #fff; }
        ...
        @media (max-width: 900px) { 
            ...
            .img-box, .txt-box { width: 100%; padding: 15px 0; } 
    ...
    <div class="product-section sauv-t">
        ...
        <div class="row">
            ...
            <div class="txt-box">
                ...
                <h3>La fragrance</h3>
                <p class="desc-full">Une composition haute couture infusée d'une fraîcheur sauvage. Le sillage est d'une puissance rare.</p>
                <ul class="specs-list">
                    <li><b>Pour :</b> Lui | <b>Occasion :</b> Soir</li>
                    <li><b>Famille :</b> AROMATIQUE Boisé</li>
                </ul>
                <h4>Le flacon</h4>
                <p class="desc-full">Un design épuré, reflet de la puissance brute et de la noblesse.</p>
            </div>
        </div>
        <div class="row rev">
            ...
            <div class="txt-box">
                ...
                <div class="desc-full" style="text-align:left; display:inline-block;">
                    ...
                    <p><b>Notes de Cœur :</b> Poivre du Sichuan</p>
                    <p><b>Notes de Fond :</b> Ambroxan</p>
                </div>
                <div class="tech-notes">
                    <p>* Notes de tête : Impression immédiate (5-15 min).</p>
                    <p>* Notes de cœur : L'âme du parfum (20-60 min).</p>
                    <p>* Notes de fond : Tenue longue durée (jusqu'à 6h).</p>
                </div>
            </div>
        </div>
    ...
    <div class="product-section stron-t">
        ...
        <div class="row">
            ...
            <div class="txt-box">
                <div class="glow-effect"></div>
                <h3>La fragrance</h3>
                <p class="desc-full">Un parfum qui vit dans le présent, porté par l'énergie de la modernité.</p>
                <ul class="specs-list">
                    <li><b>Pour :</b> Lui | <b>Occasion :</b> Jour & Nuit</li>
                    <li><b>Famille :</b> FOUGÈRE Oriental</li>
                </ul>
                <h4>Le flacon</h4>
                <p class="desc-full">Des lignes nettes et des courbes qui rappellent des épaules masculines.</p>
            </div>
        </div>
        <div class="row rev">
            ...
            <div class="txt-box">
                ...
                <div class="desc-full" style="text-align:left; display:inline-block;">
                    ...
                    <p><b>Notes de Cœur :</b> Sauge</p>
                    <p><b>Notes de Fond :</b> Vanille & Châtaigne</p>
                </div>
                <div class="tech-notes"><p>* Notes de fond : Reste le plus longtemps sur la peau.</p></div>
            </div>
        </div>
        <div class="f-wrap"><form class="f-glass"><input type="text" placeholder="Nom Complet" class="in-f" required><input type="tel" placeholder="Numéro de Téléphone" class="in-f" required><input type="text" placeholder="Ville et Adresse" class="in-f" required><button type="submit" class="btn-f">COMMANDER | 319 DH</button></form></div>
    </div>
    ...
    <div class="product-section libre-t">
        ...
        <div class="row">
            ...
            <div class="txt-box">
                <div class="glow-effect"></div>
                <h3>La fragrance</h3>
                <p class="desc-full">La tension entre la sensualité de la fleur d'oranger et la fraîcheur de la lavande.</p>
                <ul class="specs-list">
                    <li><b>Pour :</b> Elle | <b>Occasion :</b> Chic</li>
                    <li><b>Famille :</b> FLORAL Lavande</li>
                </ul>
                <h4>Le flacon</h4>
                <p class="desc-full">Un objet d'art avec le logo Cassandre incrusté dans le verre.</p>
            </div>
        </div>
        <div class="row rev">
            ...
            <div class="txt-box">
                ...
                <div class="desc-full" style="text-align:left; display:inline-block;">
                    ...
                    <p><b>Notes de Tête :</b> Mandarine</p>
                    <p><b>Notes de Cœur :</b> Lavande & Jasmin</p>
                    <p><b>Notes de Fond :</b> Vanille de Madagascar</p>
                </div>
            </div>
        </div>
        <div class="f-wrap"><form class="f-glass"><input type="text" placeholder="Nom Complet" class="in-f" required><input type="tel" placeholder="Numéro de Téléphone" class="in-f" required><input type="text" placeholder="Ville et Adresse" class="in-f" required><button type="submit" class="btn-f">COMMANDER | 319 DH</button></form></div>
    ...
    <div class="product-section gg-t">
        ...
        <div class="row">
            ...
            <div class="txt-box">
                <div class="glow-effect"></div>
                <h3>La fragrance</h3>
                <p class="desc-full">La douceur du jasmin renforce l’éclat de Good Girl. Le côté mystérieux est révélé par le cacao et la fève tonka، tandis que l'amande et le café déposent une touche d'audace.</p>
                <ul class="specs-list">
                    <li><b>Pour :</b> Elle | <b>Elle est :</b> Séductrice & Puissante</li>
                    <li><b>Occasion :</b> Jour & Nuit | <b>Famille :</b> AMBRÉE Florale</li>
                </ul>
                <h4>Le flacon</h4>
                <p class="desc-full">L’emblématique talon aiguille Good Girl est à l’image des femmes puissantes. La fragrance est Puissante et Provocante.</p>
            </div>
        </div>
        <div class="row rev">
